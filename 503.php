...
<!--[if IE]>
	<script src="<?php bloginfo('template_directory'); ?>/js/modernizr-latest.js"></script>
...
<link href="<?php bloginfo('template_directory'); ?>/css/normalize.css" rel="stylesheet" media="screen" />
